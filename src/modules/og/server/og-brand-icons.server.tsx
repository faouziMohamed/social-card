...
// Inline SVG brand/utility icons for Satori-rendered OG images.
// All icons use a 24×24 viewBox. Pass `size` and `color` as props.
...
export function XTwitterIcon({size = 20, color = 'currentColor'}: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MastodonIcon({size = 20, color = 'currentColor'}: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function AtSignIcon({size = 20, color = 'currentColor'}: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function detectSocialIcon(handle: string): React.ComponentType<IconProps> {
  ...
  if (
    ...
    lower.startsWith('@') || // treat bare @handle as Twitter/X by default
    lower.startsWith('x:')
  )
    return XTwitterIcon;
