...
import type {ProductParams} from '@/modules/og/shared/og-schemas';
...
export function productRenderer(
  ...
  const features = [p.feature1, p.feature2, p.feature3].filter(
    Boolean,
  ) as string[];
      ...
      >
        <div
          style={{
            ...
            width: leftWidth,
            height: '100%',
            backgroundImage: `radial-gradient(ellipse at 30% 50%, ${hexToRgba(accentColor, 0.12)} 0%, transparent 60%)`,
          }}
        />
        ...
        {p.cta && (
          <div
            style={{
              display: 'flex',
              alignSelf: hasScreenshot ? 'flex-start' : 'center',
              borderRadius: 9999,
              backgroundColor: accentColor,
              paddingTop: 8,
              paddingBottom: 8,
      ...
      {hasScreenshot && (
        ...
        >
          <img
            ...
            height={height}
            alt=""
            style={{objectFit: 'cover', width: rightWidth, height: '100%'}}
          />
          <div
            style={{
              position: 'absolute',
              ...
              width: 120,
              height: '100%',
              backgroundImage: `linear-gradient(to right, ${theme.bg}, transparent)`,
            }}
          />
        </div>
      )}
