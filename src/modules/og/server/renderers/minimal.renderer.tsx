...
import {isOgFontCategory} from '@/modules/og/shared/og-font-catalog';
import type {MinimalParams} from '@/modules/og/shared/og-schemas';
      ...
      >
        ...
        <div
          style={{
            display: 'flex',
            maxWidth: 960,
            marginBottom: p.description ? 24 : 0,
          }}
        >
          <span
            style={{
