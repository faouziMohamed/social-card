...
import {
  DEMO_PARAMS as BADGE_DEMO_PARAMS,
...
const SEO_USAGE: Record<string, string> = {
  ...
  'apple-touch-icon':
    '<link rel="apple-touch-icon" href="/api/seo/apple-touch-icon?initial=A" />',
  'manifest-icon':
    '{ "src": "/api/seo/manifest-icon?initial=A&size=192", "sizes": "192x192" }',
  'twitter-card':
    '<meta name="twitter:image" content="/api/seo/twitter-card?title=Hello" />',
};
                ...
                return (
                  ...
                  >
                    <Image
                      ...
                      loading="lazy"
                    />
                    <p className="text-xs font-mono text-muted-fg capitalize">
                      {template}
                    </p>
                  </div>
                );
                ...
                return (
                  ...
                  >
                    <Image
                      ...
                      loading="lazy"
                    />
                    <p className="px-3 py-2 text-xs font-mono text-muted-fg">
                      {template}
                    </p>
                  </div>
                );
