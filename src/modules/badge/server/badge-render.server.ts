...
export function premiumChip(
  ...
  return [
    rect(x, y, width, height, hexToRgba(accent, opacity), radius),
    `<rect x="${x + 0.5}" y="${y + 0.5}" width="${width - 1}" height="${height - 1}" rx="${Math.max(0, radius - 0.5)}" fill="none" stroke="${hexToRgba(accent, 0.32)}"/>`,
  ].join('');
}
...
> = {
  ...
  x: {
    ...
    color: '#000000',
    iconPath:
      'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.259 5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z',
  },
  bluesky: {
    label: 'Bluesky',
    color: '#0085ff',
    iconPath:
      'M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2zm.75 14.348c-.386.221-.75.374-.75.374s-.364-.153-.75-.374c-1.364-.78-4.5-2.918-4.5-6.098 0-2.21 1.567-4 3.5-4 .914 0 1.743.385 2.35 1.01A3.476 3.476 0 0115.5 10.25c1.933 0 3.5 1.79 3.5 4 0 3.18-3.136 5.318-5.25 6.098z',
  },
  linkedin: {
    label: 'LinkedIn',
    color: '#0077b5',
  ...
  youtube: {
    ...
    color: '#ff0000',
    iconPath:
      'M22.54 6.42a2.78 2.78 0 00-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 00-1.95 1.96A29 29 0 001 12a29 29 0 00.46 5.58a2.78 2.78 0 001.95 1.95C5.12 20 12 20 12 20s6.88 0 8.59-.47a2.78 2.78 0 001.95-1.95A29 29 0 0023 12a29 29 0 00-.46-5.58zM9.75 15.02V8.98L15.5 12l-5.75 3.02z',
  },
  twitch: {
    label: 'Twitch',
    color: '#9146ff',
  ...
  npm: {
    ...
    color: '#cb3837',
    iconPath:
      'M0 7.334v8h6.666v1.332H12v-1.332h12v-8H0zm6.666 6.664H5.334v-4H3.999v4H1.335V8.666h5.331v5.332zm4 0v1.336H8.001V8.666h5.334v5.332h-2.669zm12.001 0h-1.33v-4h-1.336v4h-1.335v-4h-1.33v4h-2.671V8.666h8.002v5.332z',
  },
  pypi: {
    label: 'PyPI',
    color: '#3775a9',
    iconPath:
      'M12.2 0C9.9 0 8 .9 8 2v2.4c0 .6.5 1.1 1.2 1.5V8H8c-.6 0-1.1.3-1.4.7L4.8 11c-.4.5-.7 1.1-.7 1.8V16c0 1.5 1.2 2.7 2.7 2.7h.8v3c0 1.2 1.5 2.1 3.4 2.3V24h2v-.1c1.9-.2 3.4-1.1 3.4-2.3v-3h.8c1.5 0 2.7-1.2 2.7-2.7v-3.2c0-.7-.3-1.3-.7-1.8l-1.8-2.3c-.3-.4-.8-.7-1.4-.7h-1.2V5.9c.7-.4 1.2-.9 1.2-1.5V2c0-1.1-1.9-2-4.3-2h-.3zM10 2.3c.6-.2 1.4-.3 2.2-.3s1.6.1 2.2.3V4H10V2.3z',
  },
};
